...
<div class="container bg-light mt-5">
    <div class="row mt-3">
        ...
        <div class="col-lg">
            <form:form method="post" action="${pageContext.request.contextPath}/khachHang/update/${khachHang.maKH}"  modelAttribute="khachHang">
			    ...
			    <div class="form-group mt-3">
			        <form:label path="tenKH" for="tenKH" style="font-weight: bold">TÊN KH<sup style="color: red" title="Bắt buộc nhập">*</sup></form:label>
			        <form:input id="tenKH" path="tenKH" cssClass="form-control" placeholder="Nhập ten KH ..."/>
			    </div>
			
			    <div class="form-group mt-3">
			        <form:label path="diaChi" for="diaChi" style="font-weight: bold">ĐỊA CHỈ<sup style="color: red" title="Bắt buộc nhập">*</sup></form:label>
